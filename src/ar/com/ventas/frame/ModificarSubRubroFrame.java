...
public class ModificarSubRubroFrame extends javax.swing.JFrame {
     ...
     * @param subRubro
     */
    public ModificarSubRubroFrame(SubRubro2 subRubro) {
        initComponents();
...
//        SubRubro2 subRubro = new SubRubro2();
        ...
        if(activoChk.isSelected()){
            ...
            subRubro.setActivo(false);
        }
        try {
            new SubRubro2Service().updateSubRubro(subRubro);
        } catch (Exception ex) {
            Logger.getLogger(ModificarSubRubroFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        limpiarCampos();
    }//GEN-LAST:event_guardarBtnActionPerformed

    private void volverBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_volverBtnActionPerformed
        AbmSubRubrosFrame srf = new AbmSubRubrosFrame();
        srf.setVisible(true);
        this.dispose();
